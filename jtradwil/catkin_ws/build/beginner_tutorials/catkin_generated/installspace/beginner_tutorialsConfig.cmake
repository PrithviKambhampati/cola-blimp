...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/robotics/git_work/cola-blimp/jtradwil/catkin_ws/install/${idir}'.  Ask the maintainer 'James Radwill <jtradwil@mtu.edu>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/robotics/git_work/cola-blimp/jtradwil/catkin_ws/install/lib;/home/robotics/git_work/cola-blimp/jtradwil/catkin_ws/devel/lib;/opt/ros/indigo/lib)
